...
//	}
//	cout << "map is\n";
//	Simulation simulation(map, 0.001, 100, pose);
//	cout << "initialization success!\n";
//	show_grid(simulation.grid);
...
//		int dy = 1;
//		int dx = -1;
//		simulation.beliefs = sense(simulation.grid[simulation.true_pose[1]][simulation.true_pose[0]], simulation.grid, simulation.beliefs, simulation.p_hit, simulation.p_miss);
//		simulation.beliefs = move(dy, dx, simulation.beliefs, simulation.blur);
//		simulation.true_pose[0] = (simulation.true_pose[0] + dx) % simulation.grid[0].size();
//		simulation.true_pose[1] = (simulation.true_pose[1] + dy) % simulation.grid.size();
//	}
//
//	show_grid(simulation.beliefs);
//	cout << "x, y = (" << simulation.true_pose[0] << ", " << simulation.true_pose[1] << ")" << endl;
